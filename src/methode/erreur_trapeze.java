...
public class erreur_trapeze {
     ...
     public String erreurMethodeTrapeze(String a1,String b1,String fx,String partition){
     ...
     try{
       ...
       df=  Derive(fx);
         ...
         double er = abs((b-a)*(b-a)*(b-a)*m)/(12*n*n);
    ...
    public String erreurMethodeSimpson(String a1, String b1, String fct, String n) {
